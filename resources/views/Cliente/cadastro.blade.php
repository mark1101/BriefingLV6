...
<div class="row" id="body-row">
    ...
    <div id="sidebar-container" class="sidebar-expanded d-none d-md-block"><!-- d-* hiddens the Sidebar in smaller devices. Its itens can be kept on the Navbar 'Menu' -->
        ...
        <ul class="list-group">
            ...
            <div class="d-flex w-100 justify-content-start align-items-center">
                ...
                <span class="menu-collapsed" style="margin-right: auto ; margin-left: auto ; display: block ; color: white ; font-size: 25px" >{{ Auth::user()->name}}</span>
            </div>
            <div class="d-flex w-100 justify-content-start align-items-center">
                <span class="fa fa-tasks fa-fw mr-3"></span>
                <span class="menu-collapsed" style="margin-right: auto ; margin-left: auto ; display: block ; color: white ; margin-bottom: 9% ; text-transform: uppercase">
                    {{Auth::user()->funcionario}}
                </span>
            </div>
    ...
    <div class="col containerMargin">
            ...
            <div class="card" style=" height: 70% ;display: block ; margin-left: auto ; margin-right: auto ; margin-top: 7% ;  background-image: linear-gradient(to bottom, #9476e4, #c4bbdb); border-color: transparent">
                <div class="card-body">
